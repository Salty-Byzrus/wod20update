...
export class GhoulDarkAgesSheet extends MortalActorSheet {
  /** @override */
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      classes: ["vtm5e", "sheet", "actor", "da-ghoul"],
      template: "systems/wod20/templates/actor/ghoul-da-sheet.html",
      width: 800,
      height: 700,
      tabs: [
        {
  ...
  get template() {
    ...
    return "systems/wod20/templates/actor/ghoul-da-sheet.html";
  }
  ...
  getData() {
    ...
    // Prepare items.
    if (this.actor.data.type === "da-ghoul") {
